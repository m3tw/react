          ...
          <div className="component-grid">
            ...
            <Surface as="section" elevation={1} className="component-section">
              ...
              <div className="component-row">
                ...
                <div className="component-row" style={{ flexWrap: 'wrap', gap: '8px', padding: '16px 0' }}>
                  {/* Assist / Suggestion */}
                  <Chip label="Assist Action" variant="assist" />
                  <Chip 
                    label="Add Event" 
                    variant="assist" 
                    leadingElement={
                  ...
                  />
                  <Chip label="Suggestion Text" variant="suggestion" />
                  
                  {/* Filter */}
                  <Chip label="Filter" variant="filter" />
                  <Chip label="Selected Filter" variant="filter" selected />
                  
                  {/* Input */}
                  <Chip 
                    label="Input Dismissible" 
                    variant="input" 
                    dismissible 
                    onDismiss={() => {}} 
                  />
                  <Chip 
                    ...
                    onDismiss={() => {}} 
                    leadingElement={
                      <div style={{ width: '24px', height: '24px', borderRadius: '50%', backgroundColor: 'var(--md-sys-color-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--md-sys-color-on-primary)', fontSize: '12px', fontWeight: 'bold' }}>
                        U
                      </div>
                    }
                  />
                  ...
                  {/* Disabled */}
                  <Chip label="Disabled Assist" disabled />
                  <Chip label="Disabled Selected" disabled selected variant="filter" />
                </div>
